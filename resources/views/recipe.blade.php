...
<body>
	<div style="padding:20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 22px;">
		<table cellpadding="0" cellspacing="0" style="width: 100%; border:0; margin-bottom: 30px; page-break-inside: auto;">
			<tr>
				<td style="padding-right: 50px; width: 60%;">
					<table cellpadding="0" cellspacing="0" style="width: 100%; border:0;">
						<tr>
							...
							<td style="border-right:2px solid #ccc; padding: 0 10px 0;text-align: center;">
								<p style="margin: 0 0 2px; padding: 0; font-weight: 700; color: #39b54a; font-size: 12px; line-height:normal; white-space: nowrap;">SERVING SIZE</p>
								<p style="margin: 0 0 0; padding: 0; font-weight: 700; color: #132d56; font-size: 15px; line-height:normal;">
								
								{{ decToFraction($recipe->serving_size) }} {{ ($recipe->unitOfMesurment)?$recipe->unitOfMesurment->name : ''}}
							</p>
							</td>
							<td style="padding: 0 10px 0;text-align: center;">
								<p style="margin: 0 0 2px; padding: 0; font-weight: 700; color: #39b54a; font-size: 12px; line-height:normal; text-transform: uppercase;">Headcount</p>
		...
		<div>
		<div style="padding: 10px; font-weight: 700; color: #fff; font-size: 14px; background-color: #1e437f; text-align: left; border:none;">Cooking Instructions</div>
		<div class="editor_box"  style=" font-size:12px; line-height:normal; 	border: 1px solid #ccc; padding:10px;">{!!$recipe->cooking_instructions!!}</div>
		</div>

		<table cellpadding="0" cellspacing="0" style="width: 100%; border:none;border-collapse: collapse; page-break-inside: auto; border-radius:20px 20px 0px 0px;">
			<tr valign="top">
				<td style="width: 65%;">
