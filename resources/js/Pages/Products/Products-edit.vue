<template>
  <Head>
  <title>{{product.name}} - Edit Product | NutriStudents K-12</title>
    ...
    <form action="#" @submit.prevent="false">
      ...
      <PageTitleLayout>
        <div class="lg:mb-0 mb-4 md:w-4/6">
          <h1 class="heading-color  2xl:text-2xl text-xl font-bold">{{product.name}}</h1>
        </div>
        <div class="w-full flex lg:flex-nowrap flex-wrap md:justify-end items-center">
          ...
          <button type="button" v-if="product.is_tenant_admin" @click="product_edit_save_script"
              ...
              <table class="min-w-full">
                ...
                <tbody>
                  ...
                  <tr class="bg-white align-top">
                    ...
                    <td colspan="3" class="px-6 py-4 whitespace-nowrap text-base text-color td-background-color">
                      ...
                      <div class="flex items-center">
                        <div class="w-full space-y-2">
                          <div v-for="(cat_counter,index) in sec_cat_counters" class="space-x-4 w-full pr-2">
                            ...
                            <i v-if="index > 0 && product.is_tenant_admin" class="fa fa-minus-circle plus-font-size products-edit-minus-color"
                              aria-hidden="true" @click="onSecondaryCatRemoveFieldRow(index)"></i>

                          </div>
                        </div>
                        <i v-if="product.is_tenant_admin" class="fa fa-plus-circle plus-font-size products-edit-minus-color cursor-pointer"
                          aria-hidden="true" @click="onSecondaryCatAddFieldRow"></i>
                      </div>
                    </td>
                  </tr>
                  ...
                  <!-- <tr class="bg-white" colspan="6">
                    ...
                    <td class="md:pl-60 pl-44 pb-4 whitespace-nowrap text-base font-bold">
                      <i class="fa fa-plus-circle plus-font-size products-edit-minus-color" aria-hidden="true"
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <td colspan="3" class="px-6 py-4 whitespace-nowrap text-base font-bold space-x-4">
                      ...
                      <i v-if="product.is_tenant_admin" class="fa fa-plus-circle plus-font-size products-edit-minus-color inline-block"
                    ...
                    <td class="py-4 whitespace-nowrap text-base font-bold uppercase">
                      ...
                      <div class="flex flex-wrap">
                        <div v-for="(product_tag,index) in form.product_tags_val" class="mb-4 mr-2">
                          <i v-if="product.is_tenant_admin" class="current_tag fa fa-minus-circle plus-font-size products-edit-minus-color inline-block"
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 uppercase">
                      <div class="flex">
                        <input type="number" min="0" step='0.01' id="weight_measurement" name="weight_measurement"
                          v-model="form.weight_measurement"
                          class="shadow-sm focus:outline-none block w-20 p-0 px-1 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center mr-2">
                        <div class="relative focus:outline-none W-44">
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <td scope="col"
                      ...
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_meat"
                    ...
                    <td scope="col"
                      ...
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_grain"
                        name="usda_componenent_serving_grain" v-model="form.usda_componenent_serving_grain"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_fruit"
                        name="usda_componenent_serving_fruit" v-model="form.usda_componenent_serving_fruit"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_milk"
                        name="usda_componenent_serving_milk" v-model="form.usda_componenent_serving_milk"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_veg" name="usda_componenent_serving_veg"
                        v-model="form.usda_componenent_serving_veg"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_vegleg"
                        name="usda_componenent_serving_vegleg" v-model="form.usda_componenent_serving_vegleg"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_vegred"
                        name="usda_componenent_serving_vegred" v-model="form.usda_componenent_serving_vegred"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_veggrn"
                    ...
                    <td scope="col"
                      ...
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_vegstar"
                        name="usda_componenent_serving_vegstar" v-model="form.usda_componenent_serving_vegstar"
                        class="shadow-sm focus:outline-none block w-20 h-9 bg-gray-100 sm:text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-50 text-center">
                    </td>
                    <td scope="col"
                      class="px-3 py-2 text-left  text-sm font-white text-gray-400 uppercase tracking-wider">
                      <input type="number" min="0" step='0.01' id="usda_componenent_serving_vegothr"
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_calories" name="nutrition_facts_calories"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_calfat" name="nutrition_facts_calfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_totalfat" name="nutrition_facts_totalfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_satfat" name="nutrition_facts_satfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_transfat" name="nutrition_facts_transfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_polysatfat" name="nutrition_facts_polysatfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_monosatfat" name="nutrition_facts_monosatfat"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_cholesterol" name="nutrition_facts_cholesterol"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_sodium" name="nutrition_facts_sodium"
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_potassium" name="nutrition_facts_potassium"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_carbs" name="nutrition_facts_carbs"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_fiber" name="nutrition_facts_fiber"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        ...
                        <input type="number" min="0" step='0.01' id="nutrition_facts_sugar" name="nutrition_facts_sugar"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        ...
                        <input type="number" min="0" step='0.01' id="nutrition_facts_protein" name="nutrition_facts_protein"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        ...
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitamina" name="nutrition_facts_vitamina"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        ...
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitaminb6" name="nutrition_facts_vitaminb6"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      ...
                      <div class="flex items-center">
                        ...
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitaminb12" name="nutrition_facts_vitaminb12"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitaminc" name="nutrition_facts_vitaminc"
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      ...
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitamind" name="nutrition_facts_vitamind"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_vitamine" name="nutrition_facts_vitamine"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_calcium" name="nutrition_facts_calcium"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_iron" name="nutrition_facts_iron"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_magnesium" name="nutrition_facts_magnesium"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_coblamin" name="nutrition_facts_coblamin"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_thiamin" name="nutrition_facts_thiamin"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_riboflavin" name="nutrition_facts_riboflavin"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_niacin" name="nutrition_facts_niacin"
                ...
                <tbody>
                  ...
                  <tr class="bg-white">
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_zinc" name="nutrition_facts_zinc"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600 ">
                      <div class="flex items-center">
                        <input type="number" min="0" step='0.01' id="nutrition_facts_water" name="nutrition_facts_water"
                    ...
                    <th class="px-3 py-3 text-left text-sm font-bold text-gray-600">
                      <div class="flex items-center">
                        <input type="numbre" min="0" id="nutrition_facts_ash" name="nutrition_facts_ash"
      ...
      <div class="w-full flex lg:flex-nowrap flex-wrap md:justify-end items-center pr-6 pb-6 md:ml-0 ml-6">
        ...
        <button  v-if="product.is_tenant_admin"  type="button" @click="product_edit_save_script"
...
<script>
  ...
  export default {
    props: ['product', 'product_components', 'product_tags', 'product_allergens', 'allergens', 'categories', 'subcategories', 'distributors', 'mass_measurements', 'unit_measurements', 'volume_measurements', 'second_categories', 'second_subcategories', 'second_categories_subcat','menu_users'],
    components: {
      DefaultLayout,
      Welcome,
      BreadcrumLayout,
    ...
    data() {
      return {
        ...
        subcat_vals: this.subcategories,
        sec_cat_counters: [],
        sec_cat_length: this.second_subcategories.length,
        sec_cat_vals: this.second_categories,
        sec_subcat_vals: this.second_categories_subcat,
        secondary_subcats: this.second_subcategories,
        ...
        form: this.$inertia.form({
          ...
          pmanufacturer_sku: this.product.manufacturer_sku,
          pgtin:this.product.gtin,
          pyield:this.product.yield,
          distributor_id_val: this.product.distributor_id,
          primary_cat_val: this.product.primary_category_id,
          primary_subcat_val: this.product.primary_sub_category_id,

          case_weight: this.product.case_weight,
          sub_case_weight: this.product.sub_case_weight,
          case_volume: this.product.case_volume,
          sub_case_volume: this.product.sub_case_volume,
          case_qty: this.product.case_quantity,
          sub_case_qty: this.product.sub_case_quantity,          

          case_mass_uom: this.product.case_weight_uom_id ? this.product.case_weight_uom_id : this.mass_measurements[0]['id'],
          subcase_mass_uom: this.product.sub_case_weight_uom_id ? this.product.sub_case_weight_uom_id : this.mass_measurements[0]['id'],

          case_vol_uom: this.product.case_volume_uom_id ? this.product.case_volume_uom_id : this.volume_measurements[0]['id'],
          case_vol_sub_uom: this.product.sub_case_volume_uom_id ? this.product.sub_case_volume_uom_id : this.volume_measurements[0]['id'],

          weight_measurement: this.product.serving_measurement_weight,
          volume_measurement: this.product.serving_measurement_volume,
          unit_measurement: this.product.serving_measurement_unit,

          mass_measurements_uom: this.product.serving_measurement_weight_uom_id ? this.product.serving_measurement_weight_uom_id : this.mass_measurements[0]['id'],
          volume_measurement_uom: this.product.serving_measurement_volume_uom_id ? this.product.serving_measurement_volume_uom_id : this.volume_measurements[0]['id'],
          unit_measurement_uom: this.product.serving_measurement_unit_uom_id ? this.product.serving_measurement_unit_uom_id : this.unit_measurements[0]['id'],          

          usda_componenent_serving_meat: this.product.usda_componenent_serving_meat,
          usda_componenent_serving_grain: this.product.usda_componenent_serving_grain,
          usda_componenent_serving_fruit: this.product.usda_componenent_serving_fruit,
          usda_componenent_serving_milk: this.product.usda_componenent_serving_milk,
          usda_componenent_serving_veg: this.product.usda_componenent_serving_veg,
          usda_componenent_serving_vegleg: this.product.usda_componenent_serving_vegleg,
          usda_componenent_serving_vegred: this.product.usda_componenent_serving_vegred,
          usda_componenent_serving_veggrn: this.product.usda_componenent_serving_veggrn,
          usda_componenent_serving_vegstar: this.product.usda_componenent_serving_vegstar,
          usda_componenent_serving_vegothr: this.product.usda_componenent_serving_vegothr,

          nutrition_facts_weight: this.product.nutrition_facts_weight,
          nutrition_facts_volume: this.product.nutrition_facts_volume,
          nutrition_facts_unit: this.product.nutrition_facts_unit,

          nutrition_mass_measurement: this.product.nutrition_facts_weight_uom_id ? this.product.nutrition_facts_weight_uom_id : this.mass_measurements[0]['id'],
          nutrition_vol_measurement: this.product.nutrition_facts_volume_uom_id ? this.product.nutrition_facts_volume_uom_id : this.volume_measurements[0]['id'],
          nutrition_unit_measurement: this.product.nutrition_facts_unit_uom_id ? this.product.nutrition_facts_unit_uom_id : this.unit_measurements[0]['id'],

          nutrition_facts_calories: this.product.nutrition_facts_calories,
          nutrition_facts_calfat: this.product.nutrition_facts_calfat,
          nutrition_facts_totalfat: this.product.nutrition_facts_totalfat,
          nutrition_facts_satfat: this.product.nutrition_facts_satfat,
          nutrition_facts_transfat: this.product.nutrition_facts_transfat,
          nutrition_facts_polysatfat: this.product.nutrition_facts_polysatfat,
          nutrition_facts_monosatfat: this.product.nutrition_facts_monosatfat,
          nutrition_facts_cholesterol: this.product.nutrition_facts_cholesterol,
          nutrition_facts_sodium: this.product.nutrition_facts_sodium,
          nutrition_facts_potassium: this.product.nutrition_facts_potassium,
          nutrition_facts_carbs: this.product.nutrition_facts_carbs,
          nutrition_facts_fiber: this.product.nutrition_facts_fiber,
          nutrition_facts_sugar: this.product.nutrition_facts_sugar,
          nutrition_facts_protein: this.product.nutrition_facts_protein,
          nutrition_facts_vitamina: this.product.nutrition_facts_vitamina,
          nutrition_facts_vitaminb6: this.product.nutrition_facts_vitaminb6,
          nutrition_facts_vitaminb12: this.product.nutrition_facts_vitaminb12,
          nutrition_facts_vitaminc: this.product.nutrition_facts_vitaminc,
          nutrition_facts_vitamind: this.product.nutrition_facts_vitamind,
          nutrition_facts_vitamine: this.product.nutrition_facts_vitamine,
          nutrition_facts_calcium: this.product.nutrition_facts_calcium,
          nutrition_facts_iron: this.product.nutrition_facts_iron,
          nutrition_facts_magnesium: this.product.nutrition_facts_magnesium,
          nutrition_facts_coblamin: this.product.nutrition_facts_coblamin,
          nutrition_facts_thiamin: this.product.nutrition_facts_thiamin,
          nutrition_facts_riboflavin: this.product.nutrition_facts_riboflavin,
          nutrition_facts_niacin: this.product.nutrition_facts_niacin,
          nutrition_facts_zinc: this.product.nutrition_facts_zinc,
          nutrition_facts_water: this.product.nutrition_facts_water,
          nutrition_facts_ash: this.product.nutrition_facts_ash,
          product_allergen_ids: this.product_allergens,
          product_tags_val: this.product_tags,
    ...
    mounted: function () {
      if (this.second_subcategories.length == 0) {
        this.sec_cat_counters.push(1);
      } else {
        for (let i = 0; i < this.second_subcategories.length; i++) {
          this.sec_cat_counters.push(i);
        }
      }
    ...
    methods: {
      ...
      product_edit_save_script() {
        if (this.secondary_subcats[0] != 'undefined') {
          this.form.secondary_subcat_ids = this.secondary_subcats;
        }
        this.form.post(this.route('products_edit_save', this.product.id), {
