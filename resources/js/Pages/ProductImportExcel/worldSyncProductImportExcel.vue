<template>
  <Head>
    <title>Products from 1World Sync | NutriStudents K-12</title>
    ...
    <BreadcrumLayout>
      <div class="flex">
        ...
        <inertia-link
          ...
          class="link-color"
          ><U>Products 1World Sync</U></inertia-link
        >
      </div>
    </BreadcrumLayout>
    ...
    >
      <PageTitleLayout>
        <div class="lg:mb-0 mb-4 md:w-4/6">
          <h1 class="heading-color 2xl:text-2xl text-xl font-bold">
            Products from 1World Sync
          </h1>
        </div>
        <div
          class="
        ...
        >
          ...
          <button
            type="button"
            @click="product_add_save_excel_import"
            class="
      ...
      <PageTitleLayout>
        ...
        >
          <div class="w-6/12">
            <div class="xl:grid xl:gap-1 xl:grid-cols-3 block pl-5 items-center">
              <label class="font-bold text-gray-700"
                >Excel 1World Sync *</label
              >
              <div>
                <input
                  type="file"
                  id="file"
                  name="file"
                  v-on:change="onProuductsyncImport"
                  ref="file"
                  class="
                    xl:mt-0
                    mt-4
                ...
                />
                <div v-if="form.errors.file" class="validation_error_msg">
                  {{ form.errors.file }}
                </div>
...
export default {
  ...
  methods: {
    ...
    product_add_save_excel_import() {
      this.form.post(this.route("import_sync_product_store"), {
        onSuccess: () => {
          // this.form.file='',
