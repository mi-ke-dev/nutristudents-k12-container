              ...
              <div class="relative pl-0 sm:w-64 w-48 lg:top-0 xl:mt-0 mt-4">
                <select
                  ...
                  class="
                    ...
                    text-gray-500
                  "
                  :disabled="!form.meal_type_id ? 'disabled': ''"
            ...
            >
              ...
              <div class="relative pl-0 sm:w-64 w-48 lg:top-0 xl:mt-0 mt-4">
                <select
                  ...
                  :disabled="!form.age_grade_offering_id ? 'disabled': ''"
                  class="
                    shadow-sm
                    focus:border-color
                    block
              ...
              <div class="relative pl-0 sm:w-64 w-48 lg:top-0 xl:mt-0 mt-4">
                <select
                  ...
                  class="
                    ...
                    text-gray-500
                  "
                  :disabled="!form.guideline_id ? 'disabled': ''"
                >
                  <option value="">Select</option>
                  <option
            ...
            >
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody>
                  ...
                  <offering-component
                    v-for="(rec_offering, index) in searched_data_offerings"
                ...
                <tbody>
                  ...
                  >
                    ...
                    >
                      ...
                      <button v-if="!this.form.siteOfferings.includes(offer.id)" type="button" @click="addRow(offer.id,offer.name,offer)">
...
export default {
  ...
  data() {
    return {
      ...
      searched_data_offerings: this.offering_array,
      haccp_names: "",
      haccp_description: "",
  ...
  methods: {
    ...
    menu_creation_add_save_script() {
      this.form.post(this.route("menu-creation-groups-edit-save",this.group.id), {
        onSuccess: () => {
          this.$toast.success("menu creation group updated successfully!");
        },
      });
    },
    addRow(offering_id,name,offer){
      var index = this.form.siteOfferings.indexOf(offering_id);
      if (index > -1) {
        this.form.siteOfferings.splice(index, 1);
      } 

      this.searched_data_offerings.forEach((value,i) => {
        if(offering_id == value['id']){
          this.searched_data_offerings.splice(i,1);   
        }
      });

      this.form.siteOfferings.push(offering_id);
      this.searched_data_offerings.push(offer);
    },
