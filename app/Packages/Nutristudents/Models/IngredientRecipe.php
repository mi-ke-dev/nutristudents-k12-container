...
class IngredientRecipe extends Model
{
    ...
    */
    ...
    {
        return $this->belongsTo(UnitOfMeasurement::class,'serving_amount_uom_id');
    }

    public function recipeUnitOfMesurment(): BelongsTo
    {
        return $this->belongsTo(UnitOfMeasurement::class,'recipe_amount_uom_id');
    }
