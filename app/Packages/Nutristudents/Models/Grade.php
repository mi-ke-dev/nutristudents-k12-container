...
//    }
    ...
    */
    ...
    public function weekCycles(): HasMany
    {
        return $this->hasMany(WeekCycle::class);

    }

    public function gradeRanges(): BelongsToMany
    {
        return $this->belongsToMany(GradeRange::class);
    }
